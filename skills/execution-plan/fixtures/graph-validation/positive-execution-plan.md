# Complete Execution Plan Graph Fixture
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| EP-GATE-1 | EP-OUT-1 | markdown-trace graph-validate | The fixture passes. | Capture command output. | Graph-validation JSON. | Exit code 0. | None. |
